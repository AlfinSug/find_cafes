...
<head>
    ...
    <title>Find Cafe - User Page</title>
    <!--
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                            <li><a href='#tabs-1'><img src="assets/images/reserv-tab.png" alt="">Reservation</a></li>
                                            <li><a href='#tabs-2'><img src="assets/images/history-tab.png" alt="">History</a></a></li>
                                            <li><a href='#tabs-3'><img src="assets/images/profil-tab.png" alt="">Profile</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
