                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a class="active" href="#">Sign In</a></li>
                            <li class="scroll-to-section"><a href="#">Create Account</a></li>
                        </ul>
                            ...
                            <div class="heading-tabs">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                            <li><a href='#tabs-1'><img src="assets/images/tab-icon1.png" alt="">User</a></li>
                                            <li><a href='#tabs-2'><img src="assets/images/tab-icon2.png" alt="">Owner</a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
