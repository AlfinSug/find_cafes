                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 text-center">
                                <img src="assets/images/signin_user_img.png" width="50%" height="150" class="rounded text-center" alt="">
                                <a class="text-center" href="index.html">
                                    <h4 class="h4 mr-5 ml-5 mt-3"><strong> Hello User,</strong><br>
                                        <h5>Please Login If You Want To Hang Out Now</h5>
                                    </h4>
                                </a>
