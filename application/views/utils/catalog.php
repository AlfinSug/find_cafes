        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="<?= base_url(); ?>home#menu">Popular</a></li>
              ...
              <li class="scroll-to-section"><a href="<?= base_url(); ?>auth_login">Sign In</a></li>
            </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 offset-lg-4 text-center">
          <div class="section-heading">
            <h6>Hong Out Now?</h6>
            <h2>Find Cafe by Open Outlet</h2>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="heading-tabs">
                <div class="row">
                  <div class="col-lg-6 offset-lg-3">
                    <ul>
                      <li><a href='#tabs-1'><img src="assets/images/history-tab.png" alt="">All</a></li>
                      <li><a href='#tabs-2'><img src="assets/images/tab-icon1.png" alt="">New Normal</a></li>
                      <li><a href='#tabs-3'><img src="assets/images/tab-icon2.png" alt="">24 Hours</a></a></li>
                    </ul>
                  </div>
                </div>
              </div>
                        ...
                        <div class="left-list">
                          <div class="col-lg-12">
                            <div class="tab-item">
                              ...
                              <div class="price2">
                                <a class="book-now" href="#">Book Now</i></a>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                        ...
                        <div class="left-list">
                          <div class="col-lg-12">
                            <div class="tab-item">
                              ...
                              <p>Lorem ipsum dolor sit amet, consectetur koit adipiscing elit, sed do.</p>
                              <div class="price">
                                <button type="button" class=" book-now" data-toggle="modal" data-target="#modalQuickView"><i class="fa fa-eye"></i></button>
                              </div>
                              <div class="price2">
                                <a class="book-now" href="#">Book Now</i></a>
                              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <h2 class="h2-responsive product-name">
                <strong>Ada Apa Dengan Koffie</strong>
              </h2>
              <h5 class="h5-responsive mt-4">
                <span class="brown-text">
                  <a class="brown-text" href="#"> lorem ipsum sit dolor amet</a>
                </span>
              ...
              <div class=" accordion md-accordion mt-5" id="accordionEx" role="tablist" aria-multiselectable="true">
                ...
                <div class="card">
                  ...
                  <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordionEx">
                    <div class="card-body">
                      <h6 class="h6-responsive mt-2">
                        <span class="grey-text">
                          <a class="grey-text" href=""><i class="fa fa-instagram"></i> aadk@gmail.com</a>
                        </span>
                      </h6>
                      <h6 class="h6-responsive mt-4">
                        <span class="grey-text">
                          <a class="grey-text" href=""><i class="fa fa-envelope"></i> aadk@gmail.com</a>
                        </span>
                      </h6>
                      <h6 class="h6-responsive mt-4">
                        <span class="grey-text">
                          <a class="grey-text" href="#"><i class="fas fa-location-arrow"></i> aadk@gmail.com</a>
                        </span>
                      </h6>
                      <h6 class="h6-responsive mt-4">
                        <span class="grey-text">
                          <a class="grey-text" href="#"><i class="fas fa-globe-americas"></i> aadk@gmail.com</a>
                        </span>
                      </h6>
                    </div>
                  </div>
                ...
                <div class="card">
                  ...
                  <div class="card-header" role="tab" id="headingTwo2">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo2">
                      <h5 class="mb-0 text-dark">
                        Opening Hours <i class="fas fa-angle-down rotate-icon"></i>
                      </h5>
                    </a>
                  </div>
                  ...
                  <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2" data-parent="#accordionEx">
                    <div class="card-body">
                      <h6 class="h6-responsive mt-4">
                        <span class="grey-text">
                          <a class="grey-text" href="#"><i class="fas fa-stopwatch"></i> Setiap Hari 10.00 - 22.00</a>
                        </span>
                      </h6>
                    </div>
                  </div>
              ...
              <div class="card-body">
                ...
                <div class="text-center">
                  ...
                  <button class="btn btn-warning">Book Now
                    <i class="fas fa-book ml-2" aria-hidden="true"></i>
                  </button>
                </div>
              </div>
              <!-- /.Add to Cart -->
